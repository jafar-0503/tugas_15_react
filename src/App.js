...
import { Grid, Table, Label, Menu, Feed, Image, Container, Comment, Header,
        Search, Icon, Form, Button } from 'semantic-ui-react';
      ...
      <Comment.Group>
        ...
        <Comment>
          ...
          <Comment.Content>
            ...
            <Comment.Text><strong>Hallo...!</strong></Comment.Text>
            <Comment.Actions>
          ...
          <Comment.Group>
            <Comment>
              ...
              <Comment.Content>
                ...
                <Comment.Text>Kamu Sekarang Tinggal Dimana Danang ???</Comment.Text>
                <Comment.Actions>
                  <Comment.Action>Reply</Comment.Action>
                </Comment.Actions>
              </Comment.Content>
        ...
        <Comment>
          ...
          <Comment.Content>
            <Comment.Author as='a'>Jafar</Comment.Author>
            <Comment.Metadata>
              <div>5 days ago</div>
            </Comment.Metadata>
            <Comment.Text>Thanks for your advice guys...</Comment.Text>
            <Comment.Actions>
              <Comment.Action>Reply</Comment.Action>
            </Comment.Actions>
          </Comment.Content>
